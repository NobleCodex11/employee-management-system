...
def seed():
    ...
    print("Seeding default lab technician...")
    lab_role = Role.objects.get(role_name="Lab Technician")
    Staff.objects.get_or_create(username="arun", defaults={"full_name": "Arun LabTech", "gender": "Male", "joining_date": "2023-01-01", "mobile_number": "1234567894", "password": "password", "role": lab_role})
    ...
    print("Seeding complete! You can login with usernames 'admin', 'receptionist', 'doctor', 'pharmacist', or 'arun' (password: 'password').")
