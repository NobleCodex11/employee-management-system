...
const LabEvaluations = () => {
    ...
    const handleEvaluateClick = (pres) => {
        ...
        setEvalData({
            lab_test_value: pres.lab_test_value || '',
                ...
                <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(0,0,0,0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 100 }}>
                    <div className="glass-panel animate-fade-in" style={{ width: '100%', maxWidth: '500px', padding: '2rem' }}>
                        ...
                        <div style={{ background: 'var(--background)', padding: '1.25rem', borderRadius: '12px', marginBottom: '1.5rem', border: '1px solid var(--border)' }}>
                            ...
                            {selectedPres.remarks && !selectedPres.lab_test_value && (
                                <p style={{ margin: '0.5rem 0 0 0', color: 'var(--warning, #eab308)', fontWeight: '600', display: 'flex', alignItems: 'center', gap: '0.25rem', borderTop: '1px dashed var(--border)', paddingTop: '0.5rem' }}>
                                    <AlertCircle size={16} /> <strong>Doctor's Notes:</strong> {selectedPres.remarks}
                                </p>
                            )}
                        </div>
